...
namespace Papara.Business.Query.CustomerQuery.GetList
{
	...
	public class GetAllCustomerQueryHandler : IRequestHandler<GetAllCustomerQuery, ApiResponse<List<CustomerResponse>>>
	{
		...
		{
			//List<Customer> entityList = await _unitOfWork.CustomerRepository.GetAllAsync();  Include olmayan GetAll

			List<Customer> entityList = await _unitOfWork.CustomerRepository.GetAllInclude(   // Include özelliği null geçilebilir
